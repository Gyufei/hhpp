    ...
    <div className="mt-[2px] flex-1 bg-bg-black p-[10px]">
      ...
      <div className="relative mt-5 w-full">
        <NumericalInput
          ...
          placeholder="0.00"
          className="h-8 w-full rounded border border-[#474747] py-[7px] pl-[10px] pr-[100px] text-xs leading-[18px] focus:border-title-white disabled:cursor-not-allowed data-[error=true]:!border-red"
        />
      ...
      <div className="mt-5 flex h-8 cursor-pointer items-center justify-center rounded bg-main text-xs leading-[18px] text-bg-black hover:brightness-90">
        Place trade
      </div>
    </div>
  );
