...
export default function ConfirmSettleBtn({
  ...
  return (
    <WithWalletConnectBtn className="w-full" chain={chain} onClick={onClick}>
      <button
        disabled={disabled}
        className="mt-4 flex h-12 w-full items-center justify-center rounded-2xl bg-main leading-6 text-txt-white disabled:cursor-not-allowed disabled:opacity-70"
      >
