...
export const PrevButton = ({ className, ...buttonProps }: ButtonProps) => {
  ...
  return (
    <button
      {...buttonProps}
      className={cn(
        "flex h-8 w-8 items-center justify-center rounded-lg bg-bg-black text-sm leading-5 text-gray data-[active=true]:bg-main data-[active=true]:text-txt-white",
        className,
      )}
      onClick={() => previous()}
  ...
  const renderPageButton = (page: number) => (
    <li key={page}>
      <a
        ...
        className={cn(
          "flex h-8 w-8 cursor-pointer items-center justify-center rounded-lg bg-bg-black text-sm leading-5 text-gray data-[active=true]:bg-main data-[active=true]:text-txt-white",
          className,
        )}
      >
        {page}
